...
# =========================
# GERMAN BASELINE 2: COUNTERFACTUAL AUGMENTATION (3 MODEL)
# =========================
SENSITIVE = 'sex'
...
def run_counterfactual_for_model(model_type):
    ...
    summary = {
        'baseline': 'counterfactual_augmentation',
...
if __name__ == '__main__':
    ...
    for model_type in MODELS:
        summary, details = run_counterfactual_for_model(model_type)
        all_summaries.append(summary)
        all_details.extend(details)
        print(json.dumps(summary, ensure_ascii=False, indent=2))
    save_json(f'{RAW_DIR}/german_counterfactual_augmentation_details_3models.json', all_details)
    save_csv(f'{PROCESSED_DIR}/german_counterfactual_augmentation_summary_3models.csv', all_summaries)
    print(f'[Saved] {PROCESSED_DIR}/german_counterfactual_augmentation_summary_3models.csv')
