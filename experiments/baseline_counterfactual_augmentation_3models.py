...
# =========================
# BASELINE 2: COUNTERFACTUAL AUGMENTATION (3 MODEL)
# =========================
...
if __name__ == '__main__':
    ...
    save_json(f'{RAW_DIR}/counterfactual_augmentation_details_3models.json', all_details)
    save_csv(f'{PROCESSED_DIR}/counterfactual_augmentation_summary_3models.csv', all_summaries)
    print(f'[Saved] {PROCESSED_DIR}/counterfactual_augmentation_summary_3models.csv')
