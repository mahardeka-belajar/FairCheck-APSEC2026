...
# =========================
# ADULT BASELINE 1: RANDOM PAIR SAMPLING (3 MODEL)
# =========================
...
if __name__ == '__main__':
    ...
    save_json(f'{RAW_DIR}/adult_random_pair_sampling_details_3models.json', all_details)
    save_csv(f'{PROCESSED_DIR}/adult_random_pair_sampling_summary_3models.csv', all_summaries)
    print(f'[Saved] {PROCESSED_DIR}/adult_random_pair_sampling_summary_3models.csv')
